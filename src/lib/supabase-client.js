 ...
 * Grouped by (schedule_id, year_level, enrollment_type) — course_id is joined as metadata.
 */
...
export async function fetchStudentStatusDirectly(entryId) {
  ...
  // 3. Get the queue config for current serving number (year-level grouping)
