...
const scheduleController = {
  async createSchedule({ enrollment_type, year_level, schedule_date, start_time, end_time }) {
    const schedule = await Schedule.create({ enrollment_type, year_level, schedule_date, start_time, end_time });
    ...
    await QueueConfig.getOrCreate(schedule.id, year_level, enrollment_type);
